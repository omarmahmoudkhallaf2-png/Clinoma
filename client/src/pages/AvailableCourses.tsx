        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {courses.map((plan, idx) => {
            ...
            return (
              ...
              >
                {isOphth ? (
                  <div className="absolute -top-4 left-10 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 text-white text-sm font-black px-6 py-2 rounded-full shadow-xl z-10">
                    <span>60 جنيه</span>
                  </div>
                ) : plan.trending ? (
                ...
                <div className="flex justify-between items-start mb-8">
                  <div className="space-y-1">
                    ...
                    {isOphth && plan.price && (
                      <div className="mt-4 bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-400 px-5 py-2.5 rounded-2xl text-xl font-black w-fit" dir="rtl">
                  ...
                  <div className={`p-4 ${isOphth ? 'bg-gradient-to-r from-orange-500 to-rose-500' : color.primary} text-white rounded-3xl shadow-lg`}>
                    {isOphth ? <Sparkles className="w-8 h-8 text-yellow-300 animate-pulse" /> : <Crown className="w-8 h-8" />}
                  </div>
                </div>
