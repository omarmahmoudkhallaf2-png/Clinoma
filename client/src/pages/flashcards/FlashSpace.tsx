...
const PEDIATRICS_SLIDES: Record<string, string[]> = {
  ...
  'Hematology & Oncology': [
    'tahdedat_pediatrics/Hematology & Oncology/Acute lymphoplastic leukemia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Aplastic anemia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/GP6D.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/HODGKIN lymphoma.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Hemophilia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Hereditary spherocytosis.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Immune thrombocytopenia (ITP).jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Iron defeciency anemia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Thalassemia.jpeg',
  ...
  'تحديدات الاطفال': [
    'tahdedat_pediatrics/CVS/Atrial Septal Defect (ASD).jpeg',
    'tahdedat_pediatrics/CVS/Complete Transposition of the Great Arteries (TGA).jpeg',
    'tahdedat_pediatrics/CVS/Patent Ductus Arteriosus (PDA).jpeg',
    'tahdedat_pediatrics/CVS/Pediatric Heart Failure (HF).jpeg',
    'tahdedat_pediatrics/CVS/Tetralogy of Fallot (TOF) & Hypercyanotic Spells.jpeg',
    'tahdedat_pediatrics/CVS/Ventricular Septal Defect (VSD) - 2.jpeg',
    'tahdedat_pediatrics/CVS/Ventricular Septal Defect (VSD) -1.jpeg',
    'tahdedat_pediatrics/Endocrinology/CHILDHOOD OBESITY.jpeg',
    'tahdedat_pediatrics/Endocrinology/Congenital hypothyrodism.jpeg',
    'tahdedat_pediatrics/Endocrinology/DIABETES MELLITUS (DM) DIABETIC KETOACIDOSIS (DKA).jpeg',
    'tahdedat_pediatrics/Endocrinology/Short stature.jpeg',
    'tahdedat_pediatrics/Genetics/Down syndrome.jpeg',
    'tahdedat_pediatrics/Genetics/Prenatal diagnosis.jpeg',
    'tahdedat_pediatrics/Genetics/Turner syndrome.jpeg',
    'tahdedat_pediatrics/GIT/Cow milk allergy.jpeg',
    'tahdedat_pediatrics/GIT/GERD & HPS.jpeg',
    'tahdedat_pediatrics/GIT/Pediatrics abdominal pain.jpeg',
    'tahdedat_pediatrics/GIT/Vomiting.jpeg',
    'tahdedat_pediatrics/Growth & Development/Developmental milestones.jpeg',
    'tahdedat_pediatrics/Growth & Development/Growth charts.jpeg',
    'tahdedat_pediatrics/Growth & Development/Key development warning signs & Delayed milestone causes.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Acute lymphoplastic leukemia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Aplastic anemia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Chronic Hemolytic Anemia & Hereditary Spherocytosis.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/GP6D.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/HODGKIN lymphoma.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Hemophilia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Hereditary spherocytosis.jpeg',
    ...
    'tahdedat_pediatrics/Hematology & Oncology/Iron defeciency anemia.jpeg',
    'tahdedat_pediatrics/Hematology & Oncology/Thalassemia.jpeg',
    'tahdedat_pediatrics/Infection/Infections.jpeg',
    'tahdedat_pediatrics/Neurology/Cerebral Palsy (CP).jpeg',
    'tahdedat_pediatrics/Neurology/Duchenne muscle dystrophy.jpeg',
    'tahdedat_pediatrics/Neurology/The Floppy Infant Syndrome.jpeg',
    'tahdedat_pediatrics/Nutrition/advantages of breastfeeding & contraindication.jpeg',
    'tahdedat_pediatrics/Nutrition/PEM.jpeg',
    'tahdedat_pediatrics/Nutrition/Rickets.jpeg'
  ],
  'معسكر الورقة الأولى': [
...
const FlashSpace = () => {
  ...
  const renderSystemCard = (sys: string) => {
    ...
    else if (selectedModule === 'Opthalmology' || selectedModule === 'Ophthalmology') SysIcon = Eye;
        ...
        Object.entries(SECOND_PAPER_SLIDES).forEach(([chapter, files]) => {
          files.forEach(file => {
            ...
            generatedSecondPaperBoards.push({
              ...
              system: chapter,
              disease: title,
              medicalImage: `/assets/second_paper/${chapter}/${file}`,
        ...
        <div className="flex-1 overflow-y-auto">
          {!selectedModule ? (
            ...
            <div className="h-full flex flex-col p-4 md:p-8 gap-6 md:gap-8 max-w-7xl mx-auto w-full">
              ...
              <div className="flex-1 overflow-y-auto pb-8">
                {selectedModule === 'الورقة الثانية' ? (
                  <div className="flex flex-col gap-6 text-right w-full" dir="rtl">
                    {/* Expectations Banner */}
                    <button 
                      onClick={() => {
                        if (isFamilySubscribed) {
                          navigate('/flashcards/second-paper-expectations');
                        } else {
                          setShowSubscriptionModal(true);
                        }
                      }}
                      className="group relative w-full bg-gradient-to-r from-purple-950 via-[#1b153b] to-indigo-950 border border-purple-500/30 hover:border-purple-400/60 rounded-3xl p-6 text-right transition-all duration-500 active:scale-[0.99] hover:scale-[1.01] overflow-hidden flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 shadow-[0_4px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_0_35px_rgba(168,85,247,0.25)] cursor-pointer"
                    >
                      {/* Purple Animated Glow Background */}
                      <div className="absolute -right-20 -top-20 w-60 h-60 bg-gradient-to-br from-purple-500/15 to-indigo-500/5 rounded-full blur-3xl -z-10 group-hover:scale-150 group-hover:from-purple-400/25 transition-all duration-700 ease-out" />
                      
                      <div className="flex items-center gap-4 z-10 text-right">
                        <div className="w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 shadow-[0_0_20px_rgba(168,85,247,0.15)] group-hover:shadow-[0_0_25px_rgba(168,85,247,0.35)] transition-all duration-500 bg-gradient-to-br from-purple-500/20 to-indigo-650/10 border border-purple-500/40 group-hover:border-purple-400 text-purple-300 animate-pulse">
                          <Trophy className="w-7 h-7 filter drop-shadow-[0_0_5px_rgba(168,85,247,0.5)]" />
                        </div>
                        <div className="text-right">
                          <div className="flex items-center gap-2 flex-wrap justify-start">
                            <h3 className="font-black text-xl md:text-2xl text-transparent bg-clip-text bg-gradient-to-r from-purple-100 via-pink-200 to-indigo-100 group-hover:from-white group-hover:to-purple-200 transition-all duration-500">
                              توقعات كلينوما للورقة الثانية 🎯
                            </h3>
                            {!isFamilySubscribed && (
                          ...
                          <p className="text-purple-300/60 group-hover:text-purple-200/80 text-xs font-semibold tracking-wide transition-colors duration-500 mt-1">
                            مجموعة توقعات حصرية لأهم النقاط والحالات الطبية الشائعة للورقة الثانية
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-end gap-3 z-10 shrink-0">
                        {isFamilySubscribed ? (
                          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-purple-500/10 text-purple-300 group-hover:bg-purple-500/20 group-hover:text-white transition-all duration-500 border border-purple-500/20">
                            <ChevronLeft className="w-5 h-5 rotate-180" />
                          </div>
                        ) : (
                          <span className="text-xs font-black px-4 py-2 bg-purple-500/20 hover:bg-purple-500/30 border border-purple-500/30 rounded-xl text-purple-300 transition-colors">
                            اشترك الآن للدخول
                          </span>
                        )}
                      </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 text-right">
