...
export const INITIAL_QUESTIONS: Question[] = [
...

  {
    ...
    chapterId: 5,
    type: "problem-solving",
    title: "Case 1: Adolescent Health Evaluation & Risk Factors",
    content: "A 15-year-old male comes to his family physician for routine annual medical evaluation. He has no significant medical history and receives all childhood vaccinations as reported in his family record.\n\nQuestions:\na) Enumerate five health educational messages needed for this age group.\nb) List five screening tests needed for him.\nc) Mention 5 unexplained somatic or clinical complaints that should raise suspicion of drug substance abuse in primary care.",
    answer: "a) Five health educational messages:\n1. Personal hygiene.\n2. Dental care.\n3. Proper nutrition (low fat).\n4. Wear helmet when riding a bike (accident prevention).\n5. Regular exercise.\n\nb) Five screening tests:\n1. Blood pressure.\n2. Hemoglobin percentage.\n3. Lipid profile.\n4. Depression screening.\n5. Obesity.\n\nc) Somatic/clinical complaints raising suspicion of drug abuse:\n• Unexplained excitability or anxiety.\n• Gastrointestinal tract complaints (such as dyspepsia, heartburn, loss of appetite).\n• Cardiac disorders and Hypertension (especially with poor response to treatment).\n• Depression or Sleep disturbances.\n• Sexual dysfunction.\n• Recurrent major or minor trauma.\n• Multiple somatic complaints.\n• Work absenteeism, interpersonal problems, or marital difficulties.",
    isClinical: true,
    topic: "Anticipatory Care & Immunization Guidelines"
  },
...

  {
    ...
    content: "A 10-year-old boy comes to you with uncontrolled severe nasal bleeding after trauma. You try to stop bleeding, but it doesn't. You refer the case to the nearest hospital.\n\nQuestions:\n1. Name the type of referral in this case.\n2. List four (4) causes of referral in general.\n3. Enumerate 4 general criteria that a referral letter should fulfill.\n4. State the responsibilities of the consultant receiving a referred patient.",
    answer: "1. Referral type: Urgent.\n\n2. Causes of referral:\n- Diagnosis: Inadequate diagnostic and therapeutic resources and service in the family practice clinic.\n- Management: Confirmation of diagnosis or plan of management.\n- Patient's request for referral.\n- When physician is unsatisfied with the patient prognosis.\n\n3. General criteria for referral letter:\n- Referral letter should be concise and contain essential information.\n- Select the relevant data that will help the patient and the doctor who receive the letter.\n- Use clear, simple language.\n- Clarify and specify the reasons for referral and your expectation from referral.\n- Document the referral in the file of the patient and referral register.\n\n4. Responsibilities of the consultant:\n- The consultant has the responsibility to provide his services in a timely manner depending on the urgency of the condition.\n- The consultant should communicate his findings in a timely manner to the referring physician.\n- The consultant should notify the referring physician when his or her patient has been admitted to the hospital.",
    isClinical: true,
    topic: "Referral & Consultation Processes"
  },

  {
    ...
    content: "A mother presented to the family health clinic with her 14-year-old daughter for routine follow-up and her 13-month-old breastfed baby who had been sick for the past 2 days. There was no significant medical history, and all childhood vaccinations were up-to-date as per the family health record.\n\nQuestions:\n1. Enumerate 4 elements of the periodic health examination for this 14-year-old female.\n2. Classify 4 true contraindications versus 4 conditions that are NOT contraindications to pediatric immunization.",
    answer: "1. Elements of the periodic health examination:\n- Building the database / Medical history\n- Social history\n- Occupational and environmental history (School)\n- Anticipatory guidance\n- Family history\n\n2. Classification of Immunization Contraindications:\n• True Contraindications:\n  1. Anaphylactic reaction to a vaccine.\n  2. Seizure or fever > 40.5°C within 48 hours of a pertussis vaccine.\n  3. True Egg Allergy (contraindication for MMR).\n  4. Neomycin allergy (contraindication for MMR).\n  5. Immunocompromised patient (contraindication for OPV).\n  6. Untreated moderate to severe illness with fever.\n\n• Conditions that are NOT Contraindications:\n  1. Premature birth (immunize at usual chronological age).\n  2. Recent minor infection (such as otitis media).\n  3. Penicillin allergy.\n  4. Local reaction to a previous vaccine.\n  5. Pregnant mother in the household (e.g., child getting MMR).\n  6. Breastfeeding mother (e.g., child getting OPV).",
    isClinical: true,
    topic: "Anticipatory Care & Immunization Guidelines"
  },
...

  {
    ...
    chapterId: 5,
    type: "problem-solving",
    title: "Core Principle & Comprehensiveness",
    content: "Questions:\n1. What is the core principle of family medicine care?\n2. Enumerate the integrated services included in the \"Comprehensiveness\" principle of Family Medicine.",
    answer: "1. Core principle: Family medicine is a unique clinical discipline distinguished by its process of care, not merely by its content. At the center of this process lies the patient–physician relationship, with the patient viewed within the context of the family and the community.\n\n2. Integrated services in \"Comprehensiveness\":\n• Health promotion.\n• Disease prevention.\n• Curative care.\n• Rehabilitation.\n• Physical, psychological, and social support.\n• It addresses the interface between illness and disease and integrates humanistic and ethical values into clinical decision-making.",
    isClinical: true,
    topic: "Principles of Family Medicine"
  },
...

  {
    ...
    chapterId: 5,
    type: "problem-solving",
    title: "Family Health Team Structure & Performance",
    content: "Questions:\n1. Classify the members of the Family Health Team into Clinical Staff and Administrative/Support Staff.\n2. Enumerate the responsibilities of the Family Physician as the leader of the Family Health Team.\n3. Mention 3 factors that help in upgrading and improving family health team performance.",
    answer: "1. Classification of Family Health Team:\n- Clinical Staff: Nurses, Pharmacists, Laboratory Technicians, Laboratory Assistants, Social Worker, Sanitarian.\n- Administrative and Support Staff: Assistant, Front Office Staff, Medical Records Officer, Births and Deaths Officer, Admin/Finance Staff, Pharmacy Clerk, Storage Room Officer, Janitors and Guards.\n\n2. Responsibilities of the Family Physician (Leader):\n- Directing and coordinating team activities.\n- Supporting teamwork and team building.\n- Ensuring integration of clinical, preventive, and administrative services.\n- Supervising the implementation of Primary Health Care (PHC) activities.\n\n3. Factors to improve team performance:\n- Clearly defined job descriptions for each team member.\n- Regular training and capacity-building activities.\n- Regular team meetings for planning, monitoring, and problem-solving.\n- Incentives (financial and non-financial).\n- Effective communication system.",
    isClinical: true,
    topic: "Family Health Team & PHC Services"
  },
...

  {
    ...
    chapterId: 5,
    type: "problem-solving",
    title: "Family Dynamics Forces & Continuity",
    content: "Questions:\n1. What is the function of the family in reproduction?\n2. Mention 4 types of forces that influence family activities in family dynamics.",
    answer: "1. Function in reproduction: Continuity of the family through legal marriage and childbearing.\n\n2. Forces that influence family activities in family dynamics:\n• Physical forces.\n• Emotional forces.\n• Spiritual forces.\n• Intellectual forces.",
    isClinical: true,
    topic: "Family Dynamics & The Human Life Cycle"
  },
...

  {
    ...
    chapterId: 5,
    type: "problem-solving",
    title: "Life Cycles & Stages Health Needs",
    content: "Questions:\n1. Differentiate between the human life cycle and the family life cycle.\n2. Mention the specific health needs and interventions during the \"Preconception\" stage.\n3. Enumerate 4 major pediatric health risks during the \"Breast dependence & Preschool age\" stage.",
    answer: "1. Differential:\n- The Human Life Cycle: Consists of several developmental stages, each associated with transitional events, specific health problems, and care needs.\n- The Family Life Cycle: A theoretical framework to describe the formation, maintenance, change, and dissolution of marital and family relations.\n\n2. Preconception health needs and interventions:\n- Psychological maturation and social independence.\n- Premarital counseling and examination.\n- Inter-conception care.\n- Child spacing (contraception).\n- Genetic counseling when indicated.\n\n3. Breast dependence & Preschool age risks:\n• Acute respiratory infections.\n• Diarrheal diseases.\n• Malnutrition (Protein-energy malnutrition like Kwashiorkor and Marasmus).\n• Vitamin deficiencies (Rickets, Vitamin A deficiency).",
    isClinical: true,
    topic: "Family Dynamics & The Human Life Cycle"
  },
...

  {
    ...
    chapterId: 5,
    type: "problem-solving",
    title: "Case: BBP Services, Antenatal Care & Labs",
    content: "A health team is evaluating BBP services at a primary care unit. A pregnant woman attends for antenatal care, and another patient is being referred to a secondary hospital for emergency surgery.\n\nQuestions:\n1. Mention the three levels of service delivery of the BBP.\n2. Enumerate the key characteristics of the Basic Benefit Package (BBP).\n3. Enumerate the specific services provided under the \"Antenatal Care\" component of the BBP.\n4. Compare the laboratory investigations available at the Family Health Unit (FHU) level versus the Family Health Center (FHC) level under the BBP.",
    answer: "1. Three levels of service delivery:\n- Family Health Unit (FHU)\n- Family Health Centre (FHC)\n- Hospital Level\n\n2. Key characteristics of the BBP:\n- Provides a defined and integrated set of curative, preventive, and public health services.\n- Based on population health needs, with special emphasis on poor and low-income groups.\n- Ensures cost-effectiveness and efficiency in healthcare delivery.\n- Limits duplication of services and investigations.\n- Promotes effective public-private partnership under unified quality and accreditation standards.\n\n3. Antenatal Care services under BBP:\n- Management of normal pregnancy.\n- Tetanus toxoid (TT) immunization.\n- Screening for: Hypertension (pre-eclampsia), Diabetes mellitus, Urinary tract infection, Anemia, and Thyroid disorders.\n- Referral of high-risk pregnancies to FHC or hospital.\n- Nutrition and breastfeeding counseling.\n- Vitamin A supplementation.\n\n4. Laboratory investigations comparison:\n- Family Health Unit (FHU) level: Blood glucose, Blood group and Rh factor, Erythrocyte sedimentation rate (ESR), Hemoglobin (Hb), Pregnancy test, Stool analysis, Urine analysis.\n- Family Health Center (FHC) level: All FHU tests plus Anti-streptolysin O titer (ASOT), Blood chemistry (Glucose, Liver/Kidney function tests, Electrolytes), Blood grouping and cross-matching, C-reactive protein (CRP), Cerebrospinal fluid (CSF) analysis, Complete blood count (CBC), Culture and sensitivity testing (throat swabs, smear staining, cultures, antibiotic sensitivity), and Semen analysis (infertility workup).",
    isClinical: true,
    topic: "Basic Benefit Package & Level of Care"
  },
