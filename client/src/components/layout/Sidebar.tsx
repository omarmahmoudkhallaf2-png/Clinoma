      ...
      <div className={cn(
        ...
        <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
          ...
          <nav className="space-y-1">
            ...
            {/* بنوك الأسئلة - Direct Link */}
            <button
              onClick={() => navTo('/question-banks')}
              className={cn(
                "w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all relative group",
            ...
            >
              <Database className={cn(
                "w-5 h-5 transition-transform group-hover:scale-110",
                location.pathname === '/question-banks' && "text-primary"
              )} />
            ...
            {/* Clinoma Plus - Coming Soon */}
            <div className="pt-4 mb-2 px-1">
              <button
                disabled
                className="w-full flex items-center gap-2.5 px-3 py-3 rounded-2xl transition-all relative group overflow-hidden border border-amber-500/20 bg-gradient-to-br from-amber-500/10 via-primary/5 to-card shadow-md shadow-amber-500/5 cursor-default"
              >
                ...
                <div className="relative z-10 flex items-center gap-2.5 w-full">
                  ...
                  <div className="flex flex-col flex-1 text-right" dir="rtl">
                    <div className="flex items-center justify-end gap-1.5 leading-none mb-1">
                      <span className="font-black text-sm text-foreground tracking-tight">Clinoma Plus</span>
                      <Sparkles className="w-3 h-3 text-amber-500 animate-pulse" />
                    </div>
                    <span className="text-[9px] font-black text-primary uppercase tracking-[0.15em] leading-none">Coming Soon</span>
                  </div>
                  
                  <div className="px-2 py-0.5 bg-amber-500 text-white text-[8px] font-black rounded-lg uppercase tracking-tighter shadow-sm">
                    Plus
                  </div>
                </div>
              </button>
