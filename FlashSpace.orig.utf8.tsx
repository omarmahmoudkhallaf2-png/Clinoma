...
const PEDIATRICS_SLIDES: Record<string, string[]> = {
  ...
  'Infections': [
    ...
    'Neonatal sepsis (early onset).png',
    'Viral hepatitis B.png',
    'Tuberculosis (TB).png',
  ],
  'Neurology': [
...
const PEDIATRICS_QUESTIONS: Record<string, Question[]> = {
  ...
  "_CHAPTER_Infections": [
    ...
    },
    {
      "id": "inf_match_1",
      "type": "matching",
      "front": "Match the pathognomonic clinical sign, skin manifestation, or diagnostic test in Group (A) with its exact matching disease or description in Group (B):\nGroup A: Koplik spots (Answer: B), Widal test (Answer: D), Rose spots (Answer: A), Brudzinski's sign (Answer: C)\nGroup B:\nA) A skin rash appearing on the lower chest and abdomen at the end of the 1st week of Typhoid fever.\nB) Small spots erupting on the buccal mucosa opposite the second molar teeth, pathognomonic for Measles.\nC) A sign of meningeal irritation where rapid passive flexion of the head is accompanied by brisk flexion of both knees.\nD) An agglutination test that demonstrates antibodies against somatic \"O\" and flagellar \"H\" antigens to diagnose Typhoid fever.",
      "matchingPairs": [
    ...
    {
      "id": "inf_case1_q1",
      "front": "Case 1: A 5‑year‑old boy presents with abrupt high fever (40°C), severe sore throat, purulent tonsillar exudate, and within 24 h a diffuse bright red erythematous rash that blanches on pressure, flushed cheeks with circum‑oral pallor, and a red strawberry tongue. What is the most likely diagnosis?",
      "back": "Scarlet Fever."
    },
    {
      "id": "inf_case1_q2",
      "front": "What is the specific causative organism and toxin responsible for Scarlet Fever?",
      "back": "Group A β‑hemolytic streptococci producing an erythrogenic toxin."
    },
    {
      "id": "inf_case1_q3",
    ...
    {
      "id": "inf_case2_q2",
      "front": "What CBC finding supports this diagnosis?",
      "back": "Marked leukocytosis with absolute lymphocytosis."
    },
    {
      "id": "inf_case2_q3",
      "front": "Standard antimicrobial treatment regimen and duration?",
      "back": "Erythromycin 50 mg/kg/day in 4 divided doses for 14 days."
    },
    {
      "id": "inf_case3_q1",
      "front": "Case 3: 3‑year‑old with high fever, projectile headache, vomiting, petechial rash, rigid neck, positive Kernig and Brudzinski signs. What is the diagnosis and likely organism?",
      "back": "Acute Bacterial Meningitis (Septic Meningitis), most likely Meningococci due to petechial rash."
    },
    {
      "id": "inf_case3_q2",
      "front": "Urgent diagnostic investigation required?",
    ...
    {
      "id": "inf_case4_q2",
      "front": "Investigation likely positive in second week to detect specific antibodies?",
      "back": "Widal test detecting antibodies against O and H antigens."
    },
    {
      "id": "inf_case4_q3",
      "front": "Preferred intravenous antibiotic treatment and pediatric dose?",
    ...
    {
      "id": "inf_case5_q2",
      "front": "Definitive laboratory diagnosis?",
      "back": "Finding characteristic eggs via cellophane tape test from peri‑anal skin."
    },
    {
      "id": "inf_case5_q3",
      "front": "Treatment protocol and crucial epidemiological rule for the family?",
